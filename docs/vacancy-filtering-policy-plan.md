...
Уровни Junior/Middle/Senior пока не ограничиваются. Отдельные правила для
стажировок, freelance, part-time, неоплачиваемых предложений, локаций,
зарплаты и языков нужно согласовать до реализации.
...
- Для technical PM и Engineering Manager разрешать роль только при явной
  принадлежности к engineering/software-команде; обычные PM-роли не разрешать.
...
До изменения фильтра нужно отдельно согласовать:

1. Стажировки, internships и trainee-роли: публиковать или исключать?
2. Freelance, contract, part-time и неоплачиваемые вакансии: какие разрешены?
3. География: worldwide или только определённые страны/часовые пояса?
4. Удалёнка, hybrid и office: есть ли ограничения?
5. Минимальная/максимальная зарплата и вакансии без зарплаты.
6. Нужны ли отдельные ограничения по уровню языка, гражданству и разрешению на
   работу?
7. Нужно ли публиковать руководителей разработки, если в названии нет слова
   `engineering`, но обязанности явно технические?
